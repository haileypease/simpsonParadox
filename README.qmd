...
#| message: false
#| warning: false
#| fig-cap: "Simpson's Paradox: The same data tells two different stories"
...
comparison_plot <- plot1 + plot2 +
  ...
  plot_annotation(
    ...
    theme = theme_minimal(16) +
      theme(
        plot.title = element_text(size = 20, face = "bold", hjust = 0.5, margin = margin(b = 60)),
        plot.subtitle = element_text(size = 16, hjust = 0.5, margin = margin(b = 80)),
        plot.caption = element_text(size = 12, hjust = 0, face = "italic", margin = margin(t = 60)),
...
- **Left plot:** Shows the misleading overall positive relationship
